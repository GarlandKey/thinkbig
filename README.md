...
2. Calendar page
3. Tasks page
4. Help link system using Discord
5. Moderation operations system

## Support

See the [open issues](https://github.com/100Devs-ADHD/thinkBig/issues) for a list of proposed features and known issues.
...
If you would like to say **thank you** and/or support active development of thinkBig, you may:
  ...
  * Add a [GitHub Star](https://github.com/100Devs-ADHD/thinkBig) to the project.
